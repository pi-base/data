...
---
The finite complement topology on a space $X$ is defined by taking $U \subset X$ to be open if and only if $X \setminus U$ is finite or $U = \emptyset$. For definiteness, let $X$ have cardinality $\mathfrak{c}$.
