...
Let $X=\mathbb R\cup \{\infty\}$. Let $\mathbb R$ be open in $X$ and have the usual topology of {S25}, and let open neighborhoods of $\infty$ be given by sets of the form $U\cup\{\infty\}$, where $U\subseteq \mathbb R$ is co-countable and open in the Euclidean topology. 
