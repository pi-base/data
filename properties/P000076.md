...
(equivalently, {P1}),
we do not require this separation axiom here; note the meta-property below
that shows this property holds exactly when it holds for the Kolmogorov quotient.
