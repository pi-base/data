...
A nonempty, {P37} space for which all [homotopy groups](https://en.wikipedia.org/wiki/Homotopy_group) $\pi_n(X)$ with $n\ge 1$ are trivial. Equivalently, the space is weakly homotopy equivalent to {S162}. 
