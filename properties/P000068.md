...
- This property is hereditary with respect to cofinite subspaces (If $Y\subseteq X$ is cofinite and Rothberger, use $\mathcal{U}_1, \dots, \mathcal{U}_{|X\setminus Y|}$ to cover $X\setminus Y$ and then cover $Y$).
